...
const DynamicCatGameContent = dynamic(() => import('./CatGameContent'), {
  ssr: false,
  loading: () => (
      ...
      return (
        <div className="flex h-full w-full items-center justify-center text-center p-4">
          <div>
            ...
            <p className="mb-4">
              There was an error loading the 3D cat game. This could be due to browser compatibility
