...
// Import DogGame with no SSR to ensure it only loads on the client
const DogGame = dynamic(() => import('./DogGame'), {
  ssr: false,
  loading: () => (
    <div className="flex h-screen w-full items-center justify-center bg-gray-100">
      <div className="text-center p-4">
        <div className="text-2xl font-bold mb-4">Loading Dog Game...</div>
