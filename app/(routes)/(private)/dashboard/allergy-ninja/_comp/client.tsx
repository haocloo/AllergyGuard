...
export function GameClient({ initialChildProfiles, initialAllergies }: Props) {
  const { setChildProfiles, setAllergies, childProfiles, allergies } = useGameStore();
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-gradient-to-br from-gray-50 to-white dark:from-slate-900 dark:to-slate-800 rounded-lg shadow-md p-4 border border-gray-100 dark:border-gray-700">
                  ...
                  >
                    <div className="px-3 py-2 flex justify-between items-center">
                      <div className="flex items-center">
                        <span className="h-8 w-8 rounded-full bg-gradient-to-br from-orange-400 to-red-500 text-white flex items-center justify-center mr-2 text-xs font-bold shadow-inner">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-xs font-bold text-gray-700 dark:text-gray-300 mr-1.5">Weaknesses:</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center">
                        ...
                        <div className={`rounded-full w-3 h-3 ${selectedChildId === profile.id ? 'bg-blue-500' : 'bg-gray-200 dark:bg-gray-600'}`}></div>
                      </div>
                    </div>
                  </div>
                );
            ...
            {/* Game Status */}
            <div className="mt-4 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
          ...
          <div className="w-[640px] h-[480px] scale-100 relative overflow-hidden rounded-lg shadow-lg border-4 border-orange-100 dark:border-orange-900/30">
            ...
            {selectedChildId && !gameActive && (
              <div className="absolute inset-0 z-10 bg-black/40 backdrop-blur-sm flex flex-col justify-center items-center p-6 text-center">
                <div className="h-16 w-16 rounded-full bg-gradient-to-br from-orange-400 to-red-500 text-white flex items-center justify-center mb-3 text-xl font-bold shadow-lg">
                  {childProfiles.find(p => p.id === selectedChildId)?.name.charAt(0)}
                </div>
              ...
              <div className="flex justify-center items-end mb-8 mt-4 space-x-4 md:space-x-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="h-32 w-24 bg-gradient-to-b from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 rounded-t-lg flex items-center justify-center flex-col shadow-md">
                    <div className="h-10 w-10 rounded-full bg-white dark:bg-gray-900 mb-1 flex items-center justify-center text-lg font-bold text-gray-700 dark:text-gray-300">T</div>
                  ...
                  <div className="h-40 w-28 bg-gradient-to-b from-yellow-100 to-yellow-200 dark:from-yellow-900/40 dark:to-yellow-900/60 rounded-t-lg flex items-center justify-center flex-col shadow-md relative">
                    <div className="absolute -top-5">
                      <svg className="h-10 w-10 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 1l2.928 5.924 6.542.952-4.735 4.619 1.12 6.52L10 15.924l-5.855 3.091 1.12-6.52L.53 7.876l6.542-.952L10 1z" clipRule="evenodd" />
                      </svg>
                    </div>
                    <div className="h-12 w-12 rounded-full bg-white dark:bg-gray-900 mb-1 flex items-center justify-center text-lg font-bold text-gray-700 dark:text-gray-300">A</div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="h-28 w-24 bg-gradient-to-b from-amber-100 to-amber-200 dark:from-amber-900/30 dark:to-amber-900/50 rounded-t-lg flex items-center justify-center flex-col shadow-md">
                    <div className="h-10 w-10 rounded-full bg-white dark:bg-gray-900 mb-1 flex items-center justify-center text-lg font-bold text-gray-700 dark:text-gray-300">Z</div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700">
                      <th className="py-2 px-3 text-left text-gray-500 dark:text-gray-400 font-medium text-sm">Rank</th>
                      <th className="py-2 px-3 text-left text-gray-500 dark:text-gray-400 font-medium text-sm">Ninja</th>
                      <th className="py-2 px-3 text-right text-gray-500 dark:text-gray-400 font-medium text-sm">Score</th>
                      <th className="py-2 px-3 text-center text-gray-500 dark:text-gray-400 font-medium text-sm">Badges</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-yellow-50 dark:bg-yellow-900/20 border-b border-gray-200 dark:border-gray-700">
                      <td className="py-3 px-3 font-semibold text-yellow-600 dark:text-yellow-400">1</td>
                    ...
                    <tr className="bg-amber-50 dark:bg-amber-900/20 border-b border-gray-200 dark:border-gray-700">
                      <td className="py-3 px-3 font-semibold text-amber-600 dark:text-amber-400">3</td>
                    ...
                    <div className="mx-auto mb-2">
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          fallback.className = 'h-20 w-20 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mx-auto text-sm font-medium text-gray-500 dark:text-gray-400';
