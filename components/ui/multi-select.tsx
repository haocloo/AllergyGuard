        ...
        <div
          className={cn(
            "min-h-10 rounded-md border border-input text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2",
            {
              ...
              "border-red-500 focus-within:ring-0 ring-offset-0": isError,
            },
            className
          )}
          onClick={() => {
            ...
            {selected.map((option) => {
              return (
                <Badge
                  ...
                  key={option.value}
                  className={cn(
                    "flex items-center data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground",
